...
<template>
  <div
    class="min-h-full h-full w-full sm:max-w-full sm:w-full sm:min-h-full sm:h-full flex flex-col justify-between"
  >
    <div class="flex flex-col gap-2">
      ...
      <div class="flex flex-col gap-2 pb-4 flex-1 overflow-auto">
        ...
        <ScrollableContainer class="flex-col gap-2 px-4 py-1">
